...
export const EN: TranslationSchema = {
  ...
  handlers: {
    basic: {
      ...
      copyNotFound: "no assistant response found to copy",
      copyOsc52: "✓ copied {chars} characters to clipboard",
      copyFile: "✓ copied {chars} characters — clipboard not available, saved to {path}",
      copyFailed: "✗ failed to copy — neither clipboard nor temp file available",
